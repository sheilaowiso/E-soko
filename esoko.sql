...
CREATE TABLE IF NOT EXISTS `product_level` (
  ...
  `girls` varchar(10) NOT NULL DEFAULT 'no',
  `boys` varchar(10) NOT NULL DEFAULT 'no',
  `women` varchar(10) NOT NULL DEFAULT 'no',
  `men` varchar(10) NOT NULL DEFAULT 'no',
  `school` varchar(10) NOT NULL DEFAULT 'no',
  `ladies` varchar(10) NOT NULL DEFAULT 'no',
  `men` varchar(10) NOT NULL DEFAULT 'no',
  `travel` varchar(10) NOT NULL DEFAULT 'no',
  `women` varchar(10) NOT NULL DEFAULT 'no',
  `men` varchar(10) NOT NULL DEFAULT 'no',
  `kids` varchar(10) NOT NULL DEFAULT 'no',
  PRIMARY KEY (`id`)
...
INSERT INTO `product_level` (`id`, `product_id`, `girls`, `boys`, `women`, `men`, `school`, `ladies`, `men`, `travel`, `women`, `men`, `kids`) VALUES
